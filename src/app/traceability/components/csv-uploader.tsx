...
export function CSVUploader() {
    ...
    return (
        <Card className="border-none shadow-2xl bg-white/90 backdrop-blur-xl overflow-hidden transition-all duration-500 w-full max-w-3xl mx-auto border border-slate-200">
            <CardHeader className="bg-slate-900 text-white p-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <CardTitle className="text-xl font-black tracking-tight">Importador Universal CSV</CardTitle>
                        <CardDescription className="text-blue-200/70 font-medium">Asistente de carga manual con mapeo dinámico</CardDescription>
                    </div>
                </div>
            </CardHeader>
                ...
                {step === 'mapping' && (
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="flex gap-4 pt-6 border-t border-slate-100">
                            <Button variant="outline" className="flex-1 h-12 rounded-2xl font-bold border-slate-200 hover:bg-slate-50" onClick={resetWizard}>
                    ...
                    <div className="py-12 flex flex-col items-center justify-center space-y-6">
                        ...
                        {status === 'success' && (
                            <div className="text-center space-y-6 animate-in zoom-in-95 duration-500">
                                ...
                                <Button className="bg-slate-900 text-white rounded-2xl h-12 px-10 font-bold hover:scale-105 transition-transform" onClick={resetWizard}>
                                    Volver al Dashboard
                                </Button>
                            </div>
                        )}
